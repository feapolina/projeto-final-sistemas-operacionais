...
Tudo isso foi adicionado ao makefile. E conforme o livro, as interrupções que nativamente empilham códigos de erros são *8, 10, 11, 12, 13, 14 e 17*. Pras outras tem que usar o macro no_error_code_interrupt_handler pra manter essa pilha consistente.
